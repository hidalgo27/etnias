                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txt_ubicacion">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="trans_si" name="rdo_transporte" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="trans_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="trans_no" name="rdo_transporte" class="custom-control-input">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="cuartos_i_si" name="rdo_cuartos_i" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="cuartos_i_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="cuartos_no" name="rdo_cuartos_i" class="custom-control-input">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="txt_habitaciones">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="cuartos_si" name="rdo_cuartos" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="cuartos_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="cuartos_no" name="rdo_cuartos" class="custom-control-input">
                                                <label class="custom-control-label" for="cuartos_no">No</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="txt_camas">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="servicios_si" name="rdo_servicios" class="custom-control-input" checked>
                                        <label class="custom-control-label" for="servicios_si">Si</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="servicios_no" name="rdo_servicios" class="custom-control-input">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="internet_si" name="rdo_internet" class="custom-control-input" checked>
                                        <label class="custom-control-label" for="internet_si">Si</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="internet_no" name="rdo_internet" class="custom-control-input">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="artesania_si" name="rdo_artesania" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="artesania_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="artesania_no" name="rdo_artesania" class="custom-control-input">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="alimentacion_si" name="rdo_alimentacion" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="alimentacion_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="alimentacion_no" name="rdo_alimentacion" class="custom-control-input">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="textil_si" name="rdo_textil" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="textil_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="textil_no" name="rdo_textil" class="custom-control-input">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="yachay_si" name="rdo_yachay" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="textil_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="yachay_no" name="rdo_yachay" class="custom-control-input">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="yana_si" name="rdo_yana" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="textil_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="yana_no" name="rdo_yana" class="custom-control-input">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="chaski_si" name="rdo_chaski" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="textil_si">Si</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="chaski_no" name="rdo_chaski" class="custom-control-input">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txt_otros">
                                </div>
                            </div>
                        </div>
