                            ...
                            <form action="{{route('book_path')}}" method="post" enctype="multipart/form-data" id="form_detail">
                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img src="{{asset('images/etnia.gif')}}" alt="sales" class="w-100 shadow-sm rounded-top">
                                        @foreach($actividades->precios as $precio)
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group text-left">
                                                    ...
                                                    <input type="text" class="form-control" id="custom-cells-3" name="fecha_viaje" placeholder="@lang('comunidad.escoja_fecha_viaje')" required value="{{old('fecha_viaje')}}">
                                                </div>
                                            </div>
                                        </div>
