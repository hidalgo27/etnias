                    ...
                    <form action="{{route('join_guia_post_path')}}" method="post">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div id="distrito_id" class="f@lang('join.informacion_general')oup">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="txt_perfil" class="font-weight-bold text-g-grey-light">@lang('join.perfil') linkedin</label>
